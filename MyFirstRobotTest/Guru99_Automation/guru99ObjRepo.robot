...
${obj_DP_page}  xpath=//a[contains(text(),'Deposit')]
${obj_DP_acc}  xpath=//input[@name='accountno']
${obj_DP_amt}  xpath=//input[@name='ammount']
${obj_DP_desc}  xpath=//input[@name='desc']
${obj_DP_submit}  xpath=//input[@name='AccSubmit']
${obj_DP_continue}  xpath=//a[contains(text(),'Continue')]